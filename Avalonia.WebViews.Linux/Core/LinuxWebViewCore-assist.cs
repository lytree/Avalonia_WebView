...
partial class LinuxWebViewCore
{
    ...
    //    bool WebView_DecidePolicy(nint pWebView, WebKit.Internal.NavigationPolicyDecisionHandle pPolicyDecision, PolicyDecisionType type)
    //    {
    ...
    //        WebViewUrlLoadingEventArg args = new() { Url = uri, RawArgs = policyDecision };
    ...
    //                Url = uri,
    //                UrlLoadingStrategy =
    //                    type == PolicyDecisionType.NewWindowAction
    ...
    //            this,
    //            new WebViewUrlLoadedEventArg() { IsSuccess = isSucceed, RawArgs = policyDecision }
    //        );
    //        return true;
    //    }
}
