using static Avalonia.WebView.Linux.Shared.LinuxApplicationManager;
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public delegate ulong g_signal_connect_data_delegate(
    nint instance,
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public delegate nint g_memory_input_stream_new_from_data_delegate(
    byte[] data,
    uint length,
    nint destroy
);
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public delegate nint webkit_user_script_new_delegate(
    string script,
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public delegate void webkit_user_content_manager_add_script_delegate(
    nint userContentManagerInstance,
    nint script
);

[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public delegate bool webkit_user_content_manager_register_script_message_handler_delegate(
    nint userContentManagerInstance,
    string name
);
...
public static class GtkApi
{
    static GtkApi()
    {
        __gdk_set_allowed_backends = LoadDelegate<gdk_set_allowed_backends_delegate>(
            GLibrary.Gdk,
            gdk_set_allowed_backends
        )!;
        __gdk_x11_window_get_xid = LoadDelegate<gdk_x11_window_get_xid_delegate>(
            GLibrary.Gdk,
            gdk_x11_window_get_xid
        )!;

        __gtk_widget_realize_delegate = LoadDelegate<gtk_widget_realize_delegate>(
            GLibrary.Gtk,
            gtk_widget_realize
        )!;
        __g_signal_connect_data = LoadDelegate<g_signal_connect_data_delegate>(
            GLibrary.Gtk,
            g_signal_connect_data
        )!;
        __g_memory_input_stream_new_from_data =
            LoadDelegate<g_memory_input_stream_new_from_data_delegate>(
                GLibrary.Gtk,
                g_memory_input_stream_new_from_data
            )!;

        __webkit_user_script_new = LoadDelegate<webkit_user_script_new_delegate>(
            GLibrary.Webkit,
            webkit_user_script_new
        )!;
        __webkit_user_script_unref = LoadDelegate<webkit_user_script_unref_delegate>(
            GLibrary.Webkit,
            webkit_user_script_unref
        )!;
        __webkit_user_content_manager_add_script =
            LoadDelegate<webkit_user_content_manager_add_script_delegate>(
                GLibrary.Webkit,
                webkit_user_content_manager_add_script
            )!;
        __webkit_user_content_manager_register_script_message_handler =
            LoadDelegate<webkit_user_content_manager_register_script_message_handler_delegate>(
                GLibrary.Webkit,
                webkit_user_content_manager_register_script_message_handler
            )!;
        __webkit_javascript_result_get_js_value =
            LoadDelegate<webkit_javascript_result_get_js_value_delegate>(
                GLibrary.Webkit,
                webkit_javascript_result_get_js_value
            )!;
        __webkit_javascript_result_unref = LoadDelegate<webkit_javascript_result_unref_delegate>(
            GLibrary.Webkit,
            webkit_javascript_result_unref
        )!;
        __jsc_value_is_string = LoadDelegate<jsc_value_is_string_delegate>(
            GLibrary.Webkit,
            jsc_value_is_string
        )!;
        __jsc_value_to_string = LoadDelegate<jsc_value_to_string_delegate>(
            GLibrary.Webkit,
            jsc_value_to_string
        )!;

        __webkit_policy_decision_ignore = LoadDelegate<webkit_policy_decision_ignore_delegate>(
            GLibrary.Webkit,
    ...
    private static string g_memory_input_stream_new_from_data =>
        nameof(g_memory_input_stream_new_from_data);
    ...
    private static string webkit_user_content_manager_add_script =>
        nameof(webkit_user_content_manager_add_script);
    private static string webkit_user_content_manager_register_script_message_handler =>
        nameof(webkit_user_content_manager_register_script_message_handler);
    private static string webkit_javascript_result_get_js_value =>
        nameof(webkit_javascript_result_get_js_value);
    ...
    public static ulong AddSignalConnect(
        nint instance,
        string detailed_signal,
        nint c_handler,
        nint data
    ...
    {
        return __g_signal_connect_data.Invoke(
            instance,
            detailed_signal,
            c_handler,
            data,
    ...
    public static nint MarshalToGLibInputStream(byte[] data, uint length, nint destroy) =>
        __g_memory_input_stream_new_from_data.Invoke(data, length, destroy);

    public static nint MarshalToGLibInputStream(byte[] data, long length) =>
        MarshalToGLibInputStream(data, (uint)length, IntPtr.Zero);
    ...
    public static UserScript? CreateUserScript(string script)
    {
        ...
        var scriptHandle = __webkit_user_script_new.Invoke(
            script,
    ...
    public static nint CreateUserScriptX(string script)
    {
        ...
        return __webkit_user_script_new.Invoke(
            script,
            WebKitUserContentInjectedFrames.WEBKIT_USER_CONTENT_INJECT_ALL_FRAMES,
            WebKitUserScriptInjectionTime.WEBKIT_USER_SCRIPT_INJECT_AT_DOCUMENT_START,
            null,
    ...
    public static void ReleaseScript(nint scriptHandle) =>
        __webkit_user_script_unref.Invoke(scriptHandle);

    public static void AddScriptForUserContentManager(nint userContentManager, nint script) =>
        __webkit_user_content_manager_add_script.Invoke(userContentManager, script);

    public static bool RegisterScriptMessageHandler(nint userContentManager, string name) =>
        __webkit_user_content_manager_register_script_message_handler.Invoke(
            userContentManager,
            name
        );

    public static nint CreateJavaScriptResult(nint jsResult) =>
        __webkit_javascript_result_get_js_value.Invoke(jsResult);
    ...
    public static void IgnorePolicyDecision(nint decision) =>
        __webkit_policy_decision_ignore.Invoke(decision);

    public static void IgnorePolicyDecision(this PolicyDecision decision) =>
        IgnorePolicyDecision(decision.Handle);
}
