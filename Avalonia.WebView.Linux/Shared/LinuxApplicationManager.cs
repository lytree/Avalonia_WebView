...
public class LinuxApplicationManager
{
    ...
    {
        _librariesNotFound = [];
        _libraries = new Dictionary<GLibrary, IntPtr>();
        _libraryDefinitions = new Dictionary<GLibrary, string[]>();
        _libraryDefinitions[GLibrary.GLib] =
        [
            "libglib-2.0-0.dll",
            "libglib-2.0.so.0",
            "libglib-2.0.0.dylib",
        ...
        _libraryDefinitions[GLibrary.GObject] =
        [
        ...
        _libraryDefinitions[GLibrary.Cairo] =
        [
            "libcairo-2.dll",
            "libcairo.so.2",
            "libcairo.2.dylib",
        ...
        _libraryDefinitions[GLibrary.Gio] =
        [
            "libgio-2.0-0.dll",
            "libgio-2.0.so.0",
            "libgio-2.0.0.dylib",
        ...
        _libraryDefinitions[GLibrary.Atk] =
        [
            "libatk-1.0-0.dll",
            "libatk-1.0.so.0",
            "libatk-1.0.0.dylib",
        ...
        _libraryDefinitions[GLibrary.Pango] =
        [
            "libpango-1.0-0.dll",
            "libpango-1.0.so.0",
        ...
        _libraryDefinitions[GLibrary.Gdk] =
        [
            "libgdk-3-0.dll",
            "libgdk-3.so.0",
            "libgdk-3.0.dylib",
        ...
        _libraryDefinitions[GLibrary.GdkPixbuf] =
        [
        ...
        _libraryDefinitions[GLibrary.Gtk] =
        [
            "libgtk-3-0.dll",
            "libgtk-3.so.0",
            "libgtk-3.0.dylib",
        ...
        _libraryDefinitions[GLibrary.PangoCairo] =
        [
        ...
        _libraryDefinitions[GLibrary.GtkSource] =
        [
        ...
        _libraryDefinitions[GLibrary.Webkit] =
        [
    ...
    static nint Load(GLibrary library)
    {
        ...
        throw new DllNotFoundException(
            library + ": " + string.Join(", ", _libraryDefinitions[library])
        );
    }
