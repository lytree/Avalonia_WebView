...
partial class WebView
{
    ...
    private static readonly StyledProperty<Control?> ChildProperty = AvaloniaProperty.Register<
        WebView,
        Control?
    >(nameof(Child));
    ...
    public static readonly StyledProperty<Thickness> PaddingProperty = AvaloniaProperty.Register<
        WebView,
        Thickness
    >(nameof(Padding), defaultValue: new Thickness(0));
    ...
    public static readonly StyledProperty<IBrush?> BorderBrushProperty = AvaloniaProperty.Register<
        WebView,
        IBrush?
    >(nameof(BorderBrush));
    ...
    public static readonly StyledProperty<object?> EmptyViewerProperty = AvaloniaProperty.Register<
        WebView,
        object?
    >(nameof(EmptyViewer));
        ...
        get
        {
            ...
            if (_layoutThickness == null)
            {
                ...
                if (UseLayoutRounding)
                    borderThickness = LayoutHelper.RoundLayoutThickness(
                        borderThickness,
                        _scale,
                        _scale
                    );
