    ...
    async Task<bool> IPlatformWebView.Initialize()
    {
        ...
        try
        {
            ...
            if (options is not null)
            {
                ...
                CoreWebView2Controller coreWebView2Controller = await environment3
                    .CreateCoreWebView2ControllerAsync(intPtr, options)
                    .ConfigureAwait(true);
            ...
            try
            {
                var coreWebView2ControllerType = typeof(CoreWebView2Controller);
                var propertyInfo = coreWebView2ControllerType.GetProperty(
                    "IsBrowserHitTransparent",
                    BindingFlags.NonPublic | BindingFlags.Instance
                );
                // _browserHitTransparent = _coreWebView2Controller.IsBrowserHitTransparent;
                _browserHitTransparent =
                    propertyInfo?.GetValue(_coreWebView2Controller) is bool
                    && (bool)(propertyInfo.GetValue(_coreWebView2Controller) ?? false);
            }
