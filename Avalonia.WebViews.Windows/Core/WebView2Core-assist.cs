...
sealed partial class WebView2Core
{
    ...
    private void SyncControllerWithParentWindow(CoreWebView2Controller coreWebView2Controller)
    {
        if (coreWebView2Controller is null)
            return;
    ...
    private void ResetWebViewSize(CoreWebView2Controller coreWebView2Controller)
    {
        if (coreWebView2Controller is null)
            return;
        ...
        coreWebView2Controller.Bounds = new Rectangle(
            0,
            0,
            Convert.ToInt32(_handler.Bounds.Width * scale),
    ...
    private void ApplyDefaultWebViewSettings(CoreWebView2 coreWebView2)
    {
